// Inline SVG icons (Lucide-style, 24×24 viewBox, stroke-based).
// Rendering both toolbar icons from the same SVG system guarantees they are
// the same size and perfectly aligned, regardless of font/emoji metrics.
...
/** Puzzle piece — the "plugins" entry. */
